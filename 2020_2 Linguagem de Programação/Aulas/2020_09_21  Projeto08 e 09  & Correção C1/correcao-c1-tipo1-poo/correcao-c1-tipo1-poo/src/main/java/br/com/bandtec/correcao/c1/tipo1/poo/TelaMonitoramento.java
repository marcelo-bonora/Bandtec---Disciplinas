...
public class TelaMonitoramento extends javax.swing.JFrame {
    ...
    void atribuirLeitura(Componente componente, Integer novoValor) {
        ...
        atualizarTela(componente);
    }
    
    void atualizarTela(Componente componente) {
        
        componente.pbBarra.setValue(componente.atual);
        
        componente.lbAtual.setText(
                String.format(componente.mascara, componente.atual));
        
        componente.lbMinimo.setText(
                String.format(componente.mascara, componente.minimo));
        
        componente.lbMaximo.setText(
                String.format(componente.mascara, componente.maximo));
        
        componente.lbMedia.setText(
